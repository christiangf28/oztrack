  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          <Text style={[styles.coachName, { color: colors.text.primary }]}>Oz Coach</Text>
...
function WelcomeMessage({ onSuggest }: { onSuggest: (text: string) => void }) {
  ...
  return (
    <View style={styles.welcome}>
      ...
      <Text style={[styles.welcomeTitle, { color: colors.text.primary }]}>¡Hola! Soy tu Oz Coach</Text>
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      >
        ...
        <Text style={[styles.paywallTitle, { color: colors.text.primary }]}>Oz Coach</Text>
